...
{
    public partial class Entrada_Produto : System.Web.UI.Page
    {
        string ID_USUARIO;
        ...
        private void IncluirAlteracao()
        {
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), Guid.NewGuid().ToString(), "Msg_Warning('Informe a quantidade de produtos que entraram!');", true);
            }
            else
            {
                Tb_Produto Obj = new Tb_Produto();
